-- Fix the create_complete_student_enrollment function to properly handle foreign key relationships
...
BEGIN
  ...
  IF parent_email IS NOT NULL AND parent_email != '' THEN
    ...
    -- Link parent to student using the student ID (not user_id)
    INSERT INTO student_parents (
      student_id, 
      parent_id, 
      relationship
    ) VALUES (
      new_student_id,  -- Use the actual student ID from students table
