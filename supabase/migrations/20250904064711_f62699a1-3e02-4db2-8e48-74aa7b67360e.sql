-- Transport demo data (correct UUID arrays)
...
-- Only assign transport to first 5 students that exist
...
SELECT 
  ...
  '+44 8000000000'
FROM students s 
WHERE s.school_id = 'c8b1e1e0-7b8a-4c9d-9e2f-3a4b5c6d7e8f' 
ORDER BY s.student_number 
LIMIT 5;

-- Use actual student UUIDs for transport incidents
...
SELECT
  ...
  false
FROM 
  (SELECT id FROM students WHERE school_id = 'c8b1e1e0-7b8a-4c9d-9e2f-3a4b5c6d7e8f' ORDER BY student_number LIMIT 1) s1,
  (SELECT id FROM students WHERE school_id = 'c8b1e1e0-7b8a-4c9d-9e2f-3a4b5c6d7e8f' ORDER BY student_number LIMIT 1 OFFSET 1) s2;