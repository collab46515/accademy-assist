...
-- Insert British school periods (using integers for days: 1=Monday, 2=Tuesday, etc.)
INSERT INTO public.school_periods (school_id, period_number, period_name, start_time, end_time, days_of_week) VALUES
((SELECT id FROM schools LIMIT 1), 1, 'Period 1', '08:30:00', '09:30:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 2, 'Period 2', '09:30:00', '10:30:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 3, 'Break', '10:30:00', '10:45:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 4, 'Period 3', '10:45:00', '11:45:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 5, 'Period 4', '11:45:00', '12:45:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 6, 'Lunch', '12:45:00', '13:30:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 7, 'Period 5', '13:30:00', '14:30:00', ARRAY[1, 2, 3, 4, 5]),
((SELECT id FROM schools LIMIT 1), 8, 'Period 6', '14:30:00', '15:30:00', ARRAY[1, 2, 3, 4, 5])
