-- Update the demo data generation function to create a school first
...
DECLARE
  ...
  student_id uuid;
BEGIN
  -- Create or ensure demo school exists
  INSERT INTO schools (
    id, name, address, phone, email, website, 
    establishment_type, status, created_at
  ) VALUES (
    school_uuid,
    'Lovable Demo School',
    '123 Education Street, Learning City, LC1 2ED',
    '+44 20 7123 4567',
    'info@lovableDemo.school.com',
    'https://www.lovabledemo.school.com',
    'secondary',
    'active',
    NOW()
  ...
  -- Generate 100 students with parents
  FOR i IN 1..100 LOOP
    -- Generate student
    ...
    VALUES (new_user_id, school_uuid, 'student');
    ...
    INSERT INTO user_roles (user_id, school_id, role)
    VALUES (new_user_id, school_uuid, 'parent');

    -- Link parent to student
    INSERT INTO student_parents (student_id, parent_id, relationship)
    VALUES (student_id, new_user_id, (ARRAY['Mother', 'Father', 'Guardian'])[((i-1) % 3) + 1]);
  END LOOP;
  ...
  RETURN 'Demo data generated successfully: 1 school, ' || student_count || ' students (with parents) and ' || employee_count || ' employees created.';
END;
$$;