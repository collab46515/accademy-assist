-- Clear existing demo data and create fresh demo students with valid UUIDs
DELETE FROM students WHERE school_id = 'a8b1e1e0-7b8a-4c9d-9e2f-3a4b5c6d7e8f';
DELETE FROM profiles WHERE email LIKE '%demo.school.com';

-- Create demo students and profiles
...
SELECT 
  ds.user_id,
  'a8b1e1e0-7b8a-4c9d-9e2f-3a4b5c6d7e8f',
  ...
  true,
  CASE (ROW_NUMBER() OVER()) % 2 WHEN 0 THEN 'female' ELSE 'male' END,
