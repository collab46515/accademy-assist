...
export default function ApplicationDetailPage() {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig: Record<string, { variant: any; label: string; icon: React.ReactNode; color: string }> = {
      ...
      submitted: { variant: 'secondary', label: 'Submitted', icon: <FileText className="h-4 w-4" />, color: 'text-foreground' },
      under_review: { variant: 'default', label: 'Under Review', icon: <AlertCircle className="h-4 w-4" />, color: 'text-foreground' },
      documents_pending: { variant: 'outline', label: 'Documents Pending', icon: <AlertCircle className="h-4 w-4" />, color: 'text-foreground' },
      assessment_scheduled: { variant: 'secondary', label: 'Assessment Scheduled', icon: <Clock className="h-4 w-4" />, color: 'text-foreground' },
      assessment_complete: { variant: 'secondary', label: 'Assessment Complete', icon: <CheckCircle className="h-4 w-4" />, color: 'text-foreground' },
      interview_scheduled: { variant: 'secondary', label: 'Interview Scheduled', icon: <Clock className="h-4 w-4" />, color: 'text-foreground' },
      interview_complete: { variant: 'secondary', label: 'Interview Complete', icon: <CheckCircle className="h-4 w-4" />, color: 'text-foreground' },
      offer_sent: { variant: 'default', label: 'Offer Sent', icon: <CheckCircle className="h-4 w-4" />, color: 'text-foreground' },
      approved: { variant: 'default', label: 'Approved', icon: <CheckCircle className="h-4 w-4" />, color: 'text-foreground' },
      enrolled: { variant: 'default', label: 'Enrolled', icon: <CheckCircle className="h-4 w-4" />, color: 'text-foreground' },
      rejected: { variant: 'destructive', label: 'Rejected', icon: <XCircle className="h-4 w-4" />, color: 'text-foreground' },
      withdrawn: { variant: 'outline', label: 'Withdrawn', icon: <AlertCircle className="h-4 w-4" />, color: 'text-muted-foreground' },
    };
