...
export const TripMapPlanner: React.FC<TripMapPlannerProps> = ({ routeProfile, onBack }) => {
  ...
  const handleAutoGenerate = async () => {
    ...
    const result = await autoGenerateTrips(routeProfile.id, userSchoolId, vehicleCapacity);
    
    if (result && result.tripSuggestions.length > 0) {
      toast.success(`Generated ${result.tripSuggestions.length} trip suggestions`);
    } else {
