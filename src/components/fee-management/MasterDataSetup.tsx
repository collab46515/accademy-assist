  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Master Data Setup</h2>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Master Data Information</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground">
            <h4 className="font-medium mb-2">What's included in Master Data:</h4>
