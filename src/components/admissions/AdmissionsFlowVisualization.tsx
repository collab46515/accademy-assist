...
const WORKFLOW_STAGES = [
  { key: 'submitted', label: 'Application Submitted', icon: UserPlus, color: 'bg-blue-100 text-blue-800', stageId: 1 },
  { key: 'under_review', label: 'Review & Verify', icon: FileCheck, color: 'bg-purple-100 text-purple-800', stageId: 2 },
  { key: 'assessment_scheduled', label: 'Assessment/Interview', icon: Calendar, color: 'bg-indigo-100 text-indigo-800', stageId: 3 },
  { key: 'approved', label: 'Admission Decision', icon: CheckCircle, color: 'bg-green-100 text-green-800', stageId: 4 },
  { key: 'offer_sent', label: 'Fee Payment', icon: CreditCard, color: 'bg-emerald-100 text-emerald-800', stageId: 5 },
  { key: 'offer_accepted', label: 'Enrollment Confirmation', icon: Award, color: 'bg-green-200 text-green-900', stageId: 6 },
  { key: 'enrolled', label: 'Welcome & Onboarding', icon: GraduationCap, color: 'bg-blue-200 text-blue-900', stageId: 7 }
];
