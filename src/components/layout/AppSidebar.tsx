...
export function AppSidebar() {
  ...
  const accessibleModules = useMemo(() => {
    // Map sidebar titles to exact database module names
    const moduleNameMap: Record<string, string> = {
      'Dashboard': 'Dashboard',
      'Admissions Workflow': 'Admissions Workflow',
      'Enrollment Test': 'Enrollment Test',
      'Student Exit': 'Student Exit',
      'Curriculum & Lessons': 'Curriculum & Lessons',
