...
export const MASTER_FEE_HEADS = [
  {
    ...
    category: 'Tuition',
    default_amount: 600, // Converted to OMR (roughly 1500 GBP = 600 OMR)
    currency: 'OMR',
    is_mandatory: true,
    is_recurring: true,
  ...
  },
  {
    ...
    default_amount: 100, // Converted to OMR (roughly 250 GBP = 100 OMR)
    currency: 'OMR',
    is_mandatory: true,
    is_recurring: false,
  ...
  },
  {
    ...
    category: 'Transport',
    default_amount: 60, // Converted to OMR (roughly 150 GBP = 60 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'termly',
  ...
  },
  {
    ...
    category: 'Meals',
    default_amount: 80, // Converted to OMR (roughly 200 GBP = 80 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'termly',
  ...
  },
  {
    ...
    default_amount: 40, // Converted to OMR (roughly 100 GBP = 40 OMR)
    currency: 'OMR',
    is_mandatory: true,
    is_recurring: false,
    recurrence_frequency: '',
  ...
  },
  {
    ...
    category: 'ICT',
    default_amount: 30, // Converted to OMR (roughly 75 GBP = 30 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
  ...
  },
  {
    ...
    category: 'Laboratory',
    default_amount: 50, // Converted to OMR (roughly 120 GBP = 50 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'termly',
  ...
  },
  {
    ...
    category: 'Library',
    default_amount: 12, // Converted to OMR (roughly 30 GBP = 12 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'annually',
  ...
  },
  {
    ...
    category: 'Sports',
    default_amount: 32, // Converted to OMR (roughly 80 GBP = 32 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'termly',
  ...
  },
  {
    ...
    category: 'Boarding',
    default_amount: 1000, // Converted to OMR (roughly 2500 GBP = 1000 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'termly',
  ...
  },
  {
    ...
    default_amount: 24, // Converted to OMR (roughly 60 GBP = 24 OMR)
    currency: 'OMR',
    is_mandatory: false,
    is_recurring: true,
    recurrence_frequency: 'termly',
